        ...
        <main className="register">
            ...
            <form className="register__form">
                <div className='register__box'>
                    ...
                    <span className="register__input-error" id="name-input-error"><p>Что-то пошло не так...</p></span>
                </div>
                <div className='register__box'>
                    ...
                    />
                    <div className="register__bottom-line"></div>
                    <span className="register__input-error" id="email-input-error"><p>Что-то пошло не так...</p></span>
                </div>
                <div className='register__box'>
                    ...
                    />
                    <div className="register__bottom-line"></div>
                    <span className="register__input-error" id="password-input-error"><p>Что-то пошло не так...</p></span>
                </div>
