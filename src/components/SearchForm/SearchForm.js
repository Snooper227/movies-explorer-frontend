    ...
    return(
        <form className='searchForm'>
            ...
            <div className='searchForm__checkbox'>
                <button className={!isActive ? 'searchForm__button_checkbox' : 'searchForm__button_checkbox searchForm__button_checkbox_active'} type='button' onClick={handleIsActive}></button>
